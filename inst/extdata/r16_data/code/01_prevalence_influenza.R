...
template_file <- "E:/Group/report/round16/Parameters/Table2a_flu"
template_sheet1 <- "Table2a"
template_sheet2 <- "Table2b"

recoding_file <- "E:/Group/report/round16/Parameters/Recoding.xlsx"
recoding_from_cont_file <- "E:/Group/report/round16/Parameters/Recoding_from_continuous_flu.xlsx"
...
for (vaccinated in c("vaccinated", "unvaccinated")){
  for (res_param in c("influenzaa", "influenzab", "influenza", "influenzaab")){
    
    output_file <- paste0(output_file_tmp, "_", res_param, "_", vaccinated)
    overall_file=paste0(overall_file_tmp, "_", res_param, "_", vaccinated)
