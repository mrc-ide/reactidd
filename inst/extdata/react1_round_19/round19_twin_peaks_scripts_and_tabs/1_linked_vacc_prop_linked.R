...
# dfRes12<-readRDS("E:/dt20/linkedR12datANG.rds")
dfRes13<-readRDS("E:/dt20/linkedR13datANG.rds")
dfRes14<-readRDS("E:/dt20/linkedR14datANG.rds")
dfRes15<-readRDS("E:/dt20/linkedR15datANG.rds")
dfRes16<-readRDS("E:/dt20/linkedR16datANG.rds")
dfRes17<-readRDS("E:/dt20/linkedR17datANG.rds")
dfRes18<-readRDS("E:/dt20/linkedR18datANG.rds")
dfRes19<-readRDS("E:/dt20/linkedR19datANG.rds")

# df13<-readRDS("E:/group/saved_objects/rep13.rds")
# df14<-readRDS("E:/group/saved_objects/rep14.rds")
# df15<-readRDS("E:/group/saved_objects/rep15.rds")
# df16<-readRDS("E:/group/saved_objects/rep16.rds")
# df17<-readRDS("E:/group/saved_objects/rep17.rds")
# df18<-readRDS("E:/group/saved_objects/rep18.rds")
# df19<-readRDS("E:/group/saved_objects/rep19.rds")
#
# df17 <- df17 %>%
...
print("Bind tables")
ut_prop_tables <- rbind(prop_tables_r13,
                        prop_tables_r14, prop_tables_r15, prop_tables_r16,
                        prop_tables_r17, prop_tables_r18, prop_tables_r19) %>%
  mutate(unweighted_prop_full = paste0(percent(Unweighted_proportion, accuracy = 0.01), " (",
                                       percent(Lower, accuracy = 0.01), ", ",
...
print("binding weighted")
wt_prop_tables <- rbind(prev_tab_vacc_a3_r13,
                        prev_tab_vacc_a3_r14, prev_tab_vacc_a3_r15, prev_tab_vacc_a3_r16,
                        prev_tab_vacc_a3_r17, prev_tab_vacc_a3_r18, prev_tab_vacc_a3_r19) %>%
  mutate(vacc_res = as.numeric(vacc_res),
         ci_l = as.numeric(ci_l),
