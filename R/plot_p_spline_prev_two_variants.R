...
#' @param labs names of the the two variants
#' @param colors1 sets the three colours used for both variants and total prevalence
#' @return A list of the created plots, the raw data and CI's used in the plot, the raw data for the model fit in the plot.
#'

plot_p_spline_prev_two_variants <- function(X, Y, N, V, p_spline_fit, target_dist_between_knots = 5, spline_degree = 3, ylim=1.0,
