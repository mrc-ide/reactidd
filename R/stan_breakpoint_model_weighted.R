...
#'
stan_breakpoint_model_weighted <- function(X, Y, N,restriction_dates, iter = 5000, warmup =1000, chains=4, cores = 1){
  ...
  fit_spline <- rstan::sampling(stanmodels$breakpoint_simple,
                         iter=iter,
                         warmup = warmup,
                         chains = chains,
