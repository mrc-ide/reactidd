...
# lineage_file <- paste0("E:/Group/saved_objects/rep", round_id, "_lineage.rds")
# df_lineage <- readRDS(lineage_file)
#
...
{
  pdf(paste0("Figures/ct_values_covid/ct_by_vax_status_by_round_omicron_only.pdf"),
      width = 20, height = 20)
