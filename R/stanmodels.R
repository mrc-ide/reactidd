...
stanmodels <- c("b_splines_actual", "b_splines_actual_phe", "b_splines_actual_weighted", "b_splines_actual_weighted_incidence", "linear", "linear_phe", "linear_weighted", "shedding_exp", "shedding_exp_tdelay")
