...
#include "stanExports_b_splines_actual.h"

RCPP_MODULE(stan_fit4b_splines_actual_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_b_splines_actual")
