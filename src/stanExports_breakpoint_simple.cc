...
#include "stanExports_breakpoint_simple.h"

RCPP_MODULE(stan_fit4breakpoint_simple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_breakpoint_simple")
