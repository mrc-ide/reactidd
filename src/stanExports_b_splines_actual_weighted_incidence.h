...
namespace model_b_splines_actual_weighted_incidence_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_b_splines_actual_weighted_incidence");
    reader.add_event(89, 87, "end", "model_b_splines_actual_weighted_incidence");
    return reader;
}
...
class model_b_splines_actual_weighted_incidence
  : public stan::model::model_base_crtp<model_b_splines_actual_weighted_incidence> {
private:
        int num_data;
        int num_days;
        int num_knots;
        ...
        vector_d ext_knots;
public:
    model_b_splines_actual_weighted_incidence(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_b_splines_actual_weighted_incidence_namespace::model_b_splines_actual_weighted_incidence";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "num_days", "int", context__.to_vec());
            num_days = int(0);
            vals_i__ = context__.vals_i("num_days");
            pos__ = 0;
            num_days = vals_i__[pos__++];
            ...
            validate_non_negative_index("X_data", "num_data", num_data);
            context__.validate_dims("data initialization", "X_data", "double", context__.to_vec(num_data));
            X_data = std::vector<double>(num_data, double(0));
            vals_r__ = context__.vals_r("X_data");
            pos__ = 0;
            size_t X_data_k_0_max__ = num_data;
            for (size_t k_0__ = 0; k_0__ < X_data_k_0_max__; ++k_0__) {
                X_data[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 42;
            validate_non_negative_index("X", "num_days", num_days);
            context__.validate_dims("data initialization", "X", "double", context__.to_vec(num_days));
            X = std::vector<double>(num_days, double(0));
            vals_r__ = context__.vals_r("X");
            pos__ = 0;
            size_t X_k_0_max__ = num_days;
            for (size_t k_0__ = 0; k_0__ < X_k_0_max__; ++k_0__) {
                X[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 43;
            validate_non_negative_index("conversion_matrix", "num_days", num_days);
            validate_non_negative_index("conversion_matrix", "num_data", num_data);
            context__.validate_dims("data initialization", "conversion_matrix", "matrix_d", context__.to_vec(num_days,num_data));
            conversion_matrix = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(num_days, num_data);
            vals_r__ = context__.vals_r("conversion_matrix");
            pos__ = 0;
            size_t conversion_matrix_j_2_max__ = num_data;
            size_t conversion_matrix_j_1_max__ = num_days;
            for (size_t j_2__ = 0; j_2__ < conversion_matrix_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < conversion_matrix_j_1_max__; ++j_1__) {
                    conversion_matrix(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 44;
            context__.validate_dims("data initialization", "sens", "double", context__.to_vec());
            sens = double(0);
            ...
            validate_non_negative_index("B", "num_days", num_days);
            B = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(num_basis, num_days);
    ...
    ~model_b_splines_actual_weighted_incidence() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("incidence", "num_days", num_days);
            Eigen::Matrix<local_scalar_t__, 1, Eigen::Dynamic> incidence(num_days);
            ...
            stan::math::assign(incidence, inv_logit(to_row_vector(multiply(a, B))));
            current_statement_begin__ = 76;
            stan::math::assign(Y_hat, to_vector(multiply(multiply(incidence, conversion_matrix), sens)));
            ...
            current_statement_begin__ = 67;
            size_t incidence_j_1_max__ = num_days;
            for (size_t j_1__ = 0; j_1__ < incidence_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(incidence(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: incidence" << "(" << j_1__ << ")";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_b_splines_actual_weighted_incidence_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            current_statement_begin__ = 67;
            validate_non_negative_index("incidence", "num_days", num_days);
            Eigen::Matrix<double, 1, Eigen::Dynamic> incidence(num_days);
            stan::math::initialize(incidence, DUMMY_VAR__);
            stan::math::fill(incidence, DUMMY_VAR__);
            current_statement_begin__ = 68;
            validate_non_negative_index("Y_hat", "num_data", num_data);
            ...
            if (include_tparams__) {
                ...
                size_t incidence_j_1_max__ = num_days;
                for (size_t j_1__ = 0; j_1__ < incidence_j_1_max__; ++j_1__) {
                    vars__.push_back(incidence(j_1__));
                }
                size_t Y_hat_j_1_max__ = num_data;
                for (size_t j_1__ = 0; j_1__ < Y_hat_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_b_splines_actual_weighted_incidence";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < incidence_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "incidence" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t Y_hat_j_1_max__ = num_data;
            for (size_t j_1__ = 0; j_1__ < Y_hat_j_1_max__; ++j_1__) {
...
typedef model_b_splines_actual_weighted_incidence_namespace::model_b_splines_actual_weighted_incidence stan_model;
#ifndef USING_R
