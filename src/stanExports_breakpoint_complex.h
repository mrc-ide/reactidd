...
namespace model_breakpoint_complex_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_breakpoint_complex");
    reader.add_event(91, 89, "end", "model_breakpoint_complex");
    return reader;
}
#include <stan_meta_header.hpp>
class model_breakpoint_complex
  : public stan::model::model_base_crtp<model_breakpoint_complex> {
private:
        int num_data;
        int num_all;
        row_vector_d Y;
        ...
        double tau5;
public:
    model_breakpoint_complex(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_breakpoint_complex_namespace::model_breakpoint_complex";
        ...
        try {
            ...
            validate_non_negative_index("Vax1", "num_all", num_all);
            context__.validate_dims("data initialization", "Vax1", "vector_d", context__.to_vec(num_all));
            Vax1 = Eigen::Matrix<double, Eigen::Dynamic, 1>(num_all);
            vals_r__ = context__.vals_r("Vax1");
            pos__ = 0;
            size_t Vax1_j_1_max__ = num_all;
            for (size_t j_1__ = 0; j_1__ < Vax1_j_1_max__; ++j_1__) {
                Vax1(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 9;
            validate_non_negative_index("Vax2", "num_all", num_all);
            context__.validate_dims("data initialization", "Vax2", "vector_d", context__.to_vec(num_all));
            Vax2 = Eigen::Matrix<double, Eigen::Dynamic, 1>(num_all);
            vals_r__ = context__.vals_r("Vax2");
            pos__ = 0;
            size_t Vax2_j_1_max__ = num_all;
            for (size_t j_1__ = 0; j_1__ < Vax2_j_1_max__; ++j_1__) {
                Vax2(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 10;
            validate_non_negative_index("Delta", "num_all", num_all);
            context__.validate_dims("data initialization", "Delta", "vector_d", context__.to_vec(num_all));
            Delta = Eigen::Matrix<double, Eigen::Dynamic, 1>(num_all);
            vals_r__ = context__.vals_r("Delta");
            pos__ = 0;
            size_t Delta_j_1_max__ = num_all;
            ...
            context__.validate_dims("data initialization", "gen", "double", context__.to_vec());
            gen = double(0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 38;
        if (!(context__.contains_r("vef1")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable vef1 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("vef1");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "vef1", "double", context__.to_vec());
        double vef1(0);
        vef1 = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, vef1);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable vef1: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 39;
        if (!(context__.contains_r("vef2")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable vef2 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("vef2");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "vef2", "double", context__.to_vec());
        double vef2(0);
        vef2 = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, vef1, vef2);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable vef2: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 40;
        if (!(context__.contains_r("delta_trans")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable delta_trans missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("delta_trans");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "delta_trans", "double", context__.to_vec());
        double delta_trans(0);
        delta_trans = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(1., 10, delta_trans);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable delta_trans: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 38;
            local_scalar_t__ vef1;
            (void) vef1;  // dummy to suppress unused var warning
            if (jacobian__)
                vef1 = in__.scalar_lub_constrain(0, 1, lp__);
            else
                vef1 = in__.scalar_lub_constrain(0, 1);
            current_statement_begin__ = 39;
            local_scalar_t__ vef2;
            (void) vef2;  // dummy to suppress unused var warning
            if (jacobian__)
                vef2 = in__.scalar_lub_constrain(0, vef1, lp__);
            else
                vef2 = in__.scalar_lub_constrain(0, vef1);
            current_statement_begin__ = 40;
            local_scalar_t__ delta_trans;
            (void) delta_trans;  // dummy to suppress unused var warning
            if (jacobian__)
                delta_trans = in__.scalar_lub_constrain(1., 10, lp__);
            else
                delta_trans = in__.scalar_lub_constrain(1., 10);
            // transformed parameters
            current_statement_begin__ = 45;
            validate_non_negative_index("beta_int", "num_all", num_all);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_int(num_all);
            stan::math::initialize(beta_int, DUMMY_VAR__);
            stan::math::fill(beta_int, DUMMY_VAR__);
            ...
            for (int i = 1; i <= num_all; ++i) {
                ...
                if (as_bool(logical_lt(get_base1(X_all, i, "X_all", 1), (tau1 + delay)))) {
                    ...
                    stan::model::assign(beta_int, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                stan::math::exp(get_base1(beta, 1, "beta", 1)), 
                                "assigning variable beta_int");
            ...
            stan::math::assign(beta_t, elt_multiply(beta_int, elt_multiply(add(subtract(1, Delta), multiply(Delta, delta_trans)), add(add(subtract(subtract(1, Vax1), Vax2), multiply(Vax1, vef1)), multiply(Vax2, vef2)))));
            ...
            for (int i = 2; i <= num_all; ++i) {
                ...
                stan::model::assign(prev_t, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(prev_t, (i - 1), "prev_t", 1) * pow(get_base1(beta_t, (i - 1), "beta_t", 1), (1 / gen))), 
                            "assigning variable prev_t");
            }
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 45;
            size_t beta_int_j_1_max__ = num_all;
            for (size_t j_1__ = 0; j_1__ < beta_int_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(beta_int(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: beta_int" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable beta_int: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 46;
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("vef1");
        names__.push_back("vef2");
        names__.push_back("delta_trans");
        names__.push_back("beta_int");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_breakpoint_complex_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double vef1 = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(vef1);
        double vef2 = in__.scalar_lub_constrain(0, vef1);
        vars__.push_back(vef2);
        double delta_trans = in__.scalar_lub_constrain(1., 10);
        vars__.push_back(delta_trans);
        double lp__ = 0.0;
        ...
        try {
            ...
            current_statement_begin__ = 45;
            validate_non_negative_index("beta_int", "num_all", num_all);
            Eigen::Matrix<double, Eigen::Dynamic, 1> beta_int(num_all);
            stan::math::initialize(beta_int, DUMMY_VAR__);
            stan::math::fill(beta_int, DUMMY_VAR__);
            current_statement_begin__ = 46;
            validate_non_negative_index("beta_t", "num_all", num_all);
            ...
            if (include_tparams__) {
                size_t beta_int_j_1_max__ = num_all;
                for (size_t j_1__ = 0; j_1__ < beta_int_j_1_max__; ++j_1__) {
                    vars__.push_back(beta_int(j_1__));
                }
                size_t beta_t_j_1_max__ = num_all;
                for (size_t j_1__ = 0; j_1__ < beta_t_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_breakpoint_complex";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "vef1";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "vef2";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "delta_trans";
        param_names__.push_back(param_name_stream__.str());
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
            size_t beta_int_j_1_max__ = num_all;
            for (size_t j_1__ = 0; j_1__ < beta_int_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "beta_int" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t beta_t_j_1_max__ = num_all;
            for (size_t j_1__ = 0; j_1__ < beta_t_j_1_max__; ++j_1__) {
...
typedef model_breakpoint_complex_namespace::model_breakpoint_complex stan_model;
#ifndef USING_R
