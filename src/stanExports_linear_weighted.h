...
namespace model_linear_weighted_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_linear_weighted");
    reader.add_event(24, 22, "end", "model_linear_weighted");
    return reader;
}
#include <stan_meta_header.hpp>
class model_linear_weighted
  : public stan::model::model_base_crtp<model_linear_weighted> {
private:
        int num_data;
        row_vector_d Y;
        row_vector_d N;
        vector_d X;
public:
    model_linear_weighted(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_linear_weighted_namespace::model_linear_weighted";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "X", "vector_d", context__.to_vec(num_data));
            X = Eigen::Matrix<double, Eigen::Dynamic, 1>(num_data);
            vals_r__ = context__.vals_r("X");
            pos__ = 0;
            size_t X_j_1_max__ = num_data;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(Y_hat, stan::math::exp(add(multiply(X, beta), alpha)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_linear_weighted_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_linear_weighted_namespace::model_linear_weighted stan_model;
#ifndef USING_R
