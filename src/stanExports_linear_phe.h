...
namespace model_linear_phe_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_linear_phe");
    reader.add_event(20, 18, "end", "model_linear_phe");
    return reader;
}
#include <stan_meta_header.hpp>
class model_linear_phe
  : public stan::model::model_base_crtp<model_linear_phe> {
private:
        int num_data;
        std::vector<int> Y;
        vector_d X;
public:
    model_linear_phe(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_linear_phe_namespace::model_linear_phe";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(neg_binomial_2_log_log<propto__>(Y, add(multiply(X, beta), alpha), phi));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_linear_phe_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_linear_phe_namespace::model_linear_phe stan_model;
#ifndef USING_R
