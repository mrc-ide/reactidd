...
#include "stanExports_shedding_exp_tdelay.h"

RCPP_MODULE(stan_fit4shedding_exp_tdelay_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_shedding_exp_tdelay")
