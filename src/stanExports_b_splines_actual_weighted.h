...
namespace model_b_splines_actual_weighted_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_b_splines_actual_weighted");
    reader.add_event(80, 78, "end", "model_b_splines_actual_weighted");
    return reader;
}
...
class model_b_splines_actual_weighted
  : public stan::model::model_base_crtp<model_b_splines_actual_weighted> {
private:
        int num_data;
        int num_knots;
        vector_d knots;
        ...
        vector_d ext_knots;
public:
    model_b_splines_actual_weighted(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_b_splines_actual_weighted_namespace::model_b_splines_actual_weighted";
    ...
    ~model_b_splines_actual_weighted() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(Y_hat, inv_logit(to_vector(multiply(a, B))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_b_splines_actual_weighted_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_b_splines_actual_weighted";
    }
...
typedef model_b_splines_actual_weighted_namespace::model_b_splines_actual_weighted stan_model;
#ifndef USING_R
