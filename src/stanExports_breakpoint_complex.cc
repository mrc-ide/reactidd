...
#include "stanExports_breakpoint_complex.h"

RCPP_MODULE(stan_fit4breakpoint_complex_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_breakpoint_complex")
