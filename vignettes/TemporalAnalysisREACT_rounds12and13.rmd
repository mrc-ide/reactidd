...
# Loading the Data
First we will load the example weighted REACT data available using reactidd::load_example_data_weighted() 
...
We can also do comparisons to public data on death and hospitisations
