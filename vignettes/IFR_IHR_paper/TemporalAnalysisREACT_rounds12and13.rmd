...
death_dif<-plot_spline_difference(X_REACT, react_array_log,
                             death_data$date, death_array_log,
                             time_delay = 26)
death_dif$date <- as.Date(death_dif$date-18383, origin=as.Date("2020-05-01"))
death_dif1 <- death_dif[death_dif$date<=as.Date("2020-12-03"),]
death_dif2 <- death_dif[death_dif$date>=as.Date("2021-01-06"),]
